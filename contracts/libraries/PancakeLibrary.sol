...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal view returns (address pair) {
        ...
        //         hex'14f1d9a216352b9477a3fd6decd6ace787953f42abe68049a013dd5fc329f987') // init code hash
        //     ))));
    }
    
    // fetches and sorts the reserves for a pair
    function getTokenReserves(address factory, address tokenA, address tokenB) internal view returns (uint reserveA, uint reserveB) {
